...
Just out the data. Interesting. Console:
...
There are two shortcut keys we are learning today: command-enter (for working with code line-by-line), and command-shift-k (for sourcing entire file).
...
In your script, start looking at the data. What is the 3rd largest (by population) county in the US? Which county has the best economic connectedness?
...
Let's make a plot of population (x-axis) versus connectedness on the (y-axis). Goal is to copy/paste a copy of your plot into the Discord class-work channel. Example code:
...
Unlikely that most groups will get this far.
