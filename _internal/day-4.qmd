...
For today, we are getting more comfortable with the Terminal and with file locations on our machines. 

By end of class, we should have the data downloaded. If we have time, we might start playing around with the data in Quarto. 

Next class processes the data and starts the plotting.
