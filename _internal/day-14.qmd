...
The units are individual women.
The outcome is pulse.
There is no covariate, although we could have gender as a covariate, if we did not filter out men.
...
Can you calculate the expected value of the difference? Simple replace posterior_predict() with posterior_epred() . . .
