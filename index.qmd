...
There are no prerequisites. The programming language we will be using is R. You must have a computer with R, RStudio and Git [installed](https://happygitwithr.com). You must be able to use Zoom and to share your screen. The course is designed for absolute beginners. No programming or statistics experience is required.
