...
**Kane's (Free) Data Science Course** is offered occasionally, running for 6 weeks. The next session has not been scheduled. The workload is 10 hours per week: 3 hours in class with [former Harvard Preceptor David Kane](https://www.davidkane.info/), lecturing live on Zoom at around 8:00 PM EDT and 7 hours of work completed by students on their own. By the end of this course, students will be able to do basic data science! **There is no charge.**
